    ...
    <div className="container mx-auto px-6 py-12 lg:px-8">
      ...
      <div className="mt-12 space-y-8">
        <div className="mx-auto w-full max-w-3xl space-y-4">
          <div className="h-11 w-3/4 animate-pulse rounded-xl bg-muted/60 sm:w-1/2" />
          <div className="h-6 w-full animate-pulse rounded-xl bg-muted/50" />
        </div>
        <div className="mx-auto w-full max-w-2xl animate-pulse rounded-2xl border border-border/60 bg-muted/30 p-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          {chartSkeletons.map((_, index) => (
            <div
              key={index}
              className="h-80 animate-pulse rounded-2xl border border-border/60 bg-muted/30 p-6"
            >
        ...
        <div className="animate-pulse rounded-2xl border border-border/60 bg-muted/30 p-6">
